...
export const emptyWorkspace: Workspace = {
  ...
  taskColumns: [
    ...
    { id: 'col-due', label: 'תאריך סיום', key: 'dueDate', type: 'date', visible: true, removable: false, width: 145 },
    { id: 'col-follow', label: 'מועד מעקב', key: 'followUpDate', type: 'date', visible: true, removable: false, width: 165 },
    { id: 'col-email', label: 'מייל לקוח', key: 'emailTo', type: 'email', visible: true, removable: false, width: 190 },
  ],
